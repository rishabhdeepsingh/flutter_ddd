...
class NoteFormBloc extends Bloc<NoteFormEvent, NoteFormState> {
  NoteFormBloc(this._noteRpository) : super(NoteFormState.initial());

  final INoteRepository _noteRpository;
      ...
      saved: (e) async* {
        ...
        if (state.note.failureOption.isNone()) {
          failureOrSuccess = state.isEditing
              ? await _noteRpository.update(state.note)
              : await _noteRpository.create(state.note);
          yield state.copyWith(
            isSaving: false,
